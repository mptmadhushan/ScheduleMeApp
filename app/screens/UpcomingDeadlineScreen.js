...
import UpcomingDeadlineListItemComponent from '../components/UpcomingDeadlineListItemComponent';

class UpcomingDeadlineScreen extends Component {
                ...
                <List scrollEnabled={true} >
                    {this.state.data.map((element) => (
                        <ListItem key={element.id}>
                            <UpcomingDeadlineListItemComponent item={element} />
                        </ListItem>
                    ))}
                </List>
            </Content>
...
export default UpcomingDeadlineScreen;
